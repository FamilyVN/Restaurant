...
public class BottomSheetBehaviorV2<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    public Parcelable onSaveInstanceState(CoordinatorLayout parent, V child) {
        return new BottomSheetBehaviorV2.SavedState(super.onSaveInstanceState(parent, child),
            mState);
    }
    ...
    //recycler view that not scrolling
    public void updateScroller(View view) {
    ...
    public void onStopNestedScroll(CoordinatorLayout coordinatorLayout, V child, View target) {
        ...
        if (mViewDragHelper.smoothSlideViewTo(child, child.getLeft(), top)) {
            ...
            ViewCompat.postOnAnimation(child,
                new BottomSheetBehaviorV2.SettleRunnable(child, targetState));
        } else {
            setStateInternal(targetState);
        }
        mNestedScrolled = false;
    ...
    void startSettlingAnimation(View child, int state) {
        ...
        if (mViewDragHelper.smoothSlideViewTo(child, child.getLeft(), top)) {
            ViewCompat
                .postOnAnimation(child, new BottomSheetBehaviorV2.SettleRunnable(child, state));
        }
    }
    ...
    protected static class SavedState extends AbsSavedState {
        public static final Creator<BottomSheetBehaviorV2.SavedState> CREATOR =
            ParcelableCompat.newCreator(
                new ParcelableCompatCreatorCallbacks<SavedState>() {
                    @Override
                    public BottomSheetBehaviorV2.SavedState createFromParcel(Parcel in,
                                                                             ClassLoader loader) {
